...
- one statement about what average degree measures,
- one statement about what the degree distribution measures,
- one example showing that different degree distributions may have the same average degree.
...
- how $p$ scales with $N$,
- how $\mathbb{E}[k]$ behaves,
- why the Poisson approximation belongs to the sparse regime.
